 ...
 * e.g., "3000-xxx.yourapi.com" -> ".yourapi.com"
...
function getParentDomain(hostname: string | undefined): string | undefined {
  // Requests without a Host header must use a host-only cookie.
  ...
  // Need at least 3 parts for a subdomain (e.g., "3000-xxx.yourapi.com")
  // For "yourapi.com", we can't set a parent domain
  if (parts.length < 3) {
    return undefined;
  }

  // Return parent domain with leading dot (e.g., ".yourapi.com")
